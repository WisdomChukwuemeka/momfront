  ...
  return(
    ...
    <div className="relative">
      ...
      <motion.aside
        ...
        transition={{ type: "spring", stiffness: 100, damping: 20, opacity: 0 }}
      ...
      >
        <nav className="mt-15 flex flex-col gap-1">
          ...
          >
            <Link to="/events" className="flex items-center px-4 py-3 hover:bg-gray-800 transition-colors">
          ...
          >
            <Link to="/videos" className="flex items-center px-4 py-3 hover:bg-gray-800 transition-colors">
          ...
          >
            <Link to="/book" className="flex items-center px-4 py-3 hover:bg-gray-800 transition-colors">
          ...
          >
            <Link to="/contact" className="flex items-center px-4 py-3 hover:bg-gray-800 transition-colors">
          ...
          >
            <Link to="/testimonyform" className="flex items-center px-4 py-3 hover:bg-gray-800 transition-colors">
